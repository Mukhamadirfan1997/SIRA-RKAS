        ...
        <div class="card-header">
            ...
            <div class="flex items-center gap-2">
                <form method="GET" class="flex gap-2">
                    <input type="text" name="search" class="form-input text-sm" placeholder="Cari nama/NPSN..." value="{{ request('search') }}">
                    <button type="submit" class="btn btn-secondary btn-sm">Cari</button>
                    @if(request('search'))
                        <a href="{{ route('profil-sekolah.index') }}" class="btn btn-ghost btn-sm">Reset</a>
                    @endif
                </form>
