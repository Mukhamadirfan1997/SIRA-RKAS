...
- `TransaksiBku` — total_penerimaan, total_pengeluaran, label, jenis, jumlah, rkas_item_id, sekolah_id, tahun_anggaran_id, bulan, no_bukti, metode_pengadaan, uraian, sumber_dana_id, toko_penerima, saldo_berjalan, keterangan, total, siplah, non_siplah, jenis_belanja
...
## Files Modified
~80 files across app/, database/, and tests/ directories.
